...
const LAW_MANIFEST = [
  ...
  sourceUrl: 'https://www.indiacode.nic.in/bitstream/123456789/21070/1/bsa__iiitmanipur_english%2Bmanipuri_compressed.pdf',
  lastAmended: '2023-12-25'
},
{
    ...
    try {
      const result = await ingestDocument({
        ...
        onProgress: (done, total) => {
          // Clamp to 100 — guards against any future counter overshoot causing repeat(-1) crash
